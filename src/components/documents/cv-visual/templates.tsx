      ...
      <div className="flex">
        ...
        <aside className="w-[38%] bg-neutral-800 p-5 text-neutral-200">
          ...
          <div className="mt-4 space-y-3">
            <ContactBlock label="Contact" items={[profile.email, profile.phone, profile.location].filter((x): x is string => typeof x === "string")} />
            {links && <ContactBlock label="Links" items={[links.linkedin, links.portfolio].filter((x): x is string => typeof x === "string")} />}
