...
export function EssayViewer({ documentId, title, essay, profile, locale, updatedAt, version, dict }: {
  ...
  return (
    <div className="space-y-6 animate-rise">
      ...
      <div className="print-area rounded-xl border border-border bg-card p-8 shadow-lift sm:p-12 print:border-0 print:bg-white print:shadow-none print:p-0 dark:bg-card" style={{ fontFamily: "Arial, sans-serif" }}>
